      ...
      dist: {
        files: {
          'assets/js/scripts.min.js': [ //Automatically combine and min all js to this single file
            // comment out custom/*.js & boostrap/3.1.1/*.js lines if you plan to specify js
//            'assets/js/custom/*.js',
//            'assets/js/bootstrap/3.1.1/*.js',
            // be sure to comment out above if you plan to uncomment below
            'assets/js/custom/ieviewport.js',
//            'assets/js/custom/load-posts.js',
