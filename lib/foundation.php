...
function hdn_menu_fallback() {
	echo '<div class="menu-fallback">';
	// Translators 1: Link to Menus, 2: Link to Customize
  	printf( __( 'Customize your menu located under %1$s or %2$s the design.', 'hdn' ),
  		sprintf(  __( '<a href="%s">Menus</a>', 'hdn' ),
  			get_admin_url( get_current_blog_id(), 'nav-menus.php' )
  		),
  		sprintf(  __( '<a href="%s">Customize</a>', 'hdn' ),
...
function hdn_active_nav_class( $classes, $item ) {
...
add_filter( 'nav_menu_css_class', 'hdn_active_nav_class', 10, 2 );




function hdn_active_list_pages_class( $input ) {
...
add_filter( 'wp_list_pages', 'hdn_active_list_pages_class', 10, 2 );




class hdn_walker extends Walker_Nav_Menu {
