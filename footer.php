		...
		<div class="row">
			...
			<div class="col-md-6 text-right">
				<ul class="list-inline">
					...
					<li><a href="https://www.linkedin.com/company/houston-deaf-network" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-linkedin.png" alt="LinkedIn" /></a></li>
